...
import { Mail, Phone, MapPin, Clock, Send, Heart ,Building2 } from 'lucide-react';
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        const response = await fetch('http://localhost/yuva--public/api/contact.php', {
          method: 'POST',
          headers: {
      ...
      <section className="relative mt-12 px-4 md:px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 bg-white rounded-xl shadow-2xl p-8 md:p-12 border border-slate-100">
            <h2 className="text-[32px] font-bold font-Poppins text-secondary mb-2">Send Us a Message</h2>
            <p className="text-slate-500 mb-8 font-medium">Have questions? We'd love to hear from you.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-1">
                ...
                />
                {errors.subject && <p className="text-red-500 text-xs mt-1 ml-1 font-medium">{errors.subject}</p>}
              </div>
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-500 mb-1 block">Message</label>
                <textarea 
                  rows="5" 
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-[#F8FAFC] rounded-xl p-8 border border-slate-100 group hover:border-[#2E3192] transition-colors">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-bold font-Poppins text-xl mb-1">Our Location</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6">
              <div className="bg-[#F8FAFC] rounded-xl p-6 border border-slate-100 flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+919527402400" className="text-slate-800 hover:text-primary transition-colors">+91 9527402400</a>
                </div>
              </div>
              ...
              <div className="bg-[#F8FAFC] rounded-xl p-6 border border-slate-100 flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:admin@yuvamitra.org" className=" text-slate-800 hover:text-primary transition-colors">admin@yuvamitra.org</a>
                </div>
              </div>
            </div>
      ...
      {[
        {
          ...
          address: "Behind New Tahasil office, Rohajari Pada, Dhadgaon, Nandurbar, Pin- 425414"
        },
        {
          title: "Akkalkuwa, Nandurbar",
          phone: "+91 75076 98940",
          address: "Kuber Park, Behind Police Station, Akkalkuwa, Nandurbar, Pin- 425415"
        },
        {
          title: "Khed, Pune",
          phone: "+91 95116 47948",
          address: "2nd Floor, Radhanagari Complex, Pabal Road, Rajgurunagar (Khed), Pune. Pin. 410505"
        },
        {
          title: "Mahad, Raigad",
          phone: "+91 78989 97779",
          address: "4th Floor, Surekha Nivas, Beside Bank Of India, Ch. Shivaji Maharaj Chowk, Kakartale, Mahad, Raigad, Pin- 402301"
        }
      ].map((office, index) => (
...
<div className="absolute inset-0 bg-secondary text-white rounded-xl shadow-lg p-6 flex flex-col justify-center text-center [transform:rotateY(180deg)] backface-hidden border border-white/20">
  ...
  <div className="flex items-start gap-2 mb-3 justify-center">
    <FaMapMarkerAlt size={16} className="mt-1 text-primary shrink-0" />
