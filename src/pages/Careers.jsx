...
import { Briefcase, GraduationCap, Upload, Send, User, Mail, Phone, Calendar, BookOpen, MapPin, HeartHandshake } from "lucide-react";
    ...
    if (validateForm()) {
      ...
      setTimeout(() => {
        ...
        setFormData({
          ...
          institute: '', qualification: '', position: '', city: '', resume: null
        });
          ...
          <div className="grid lg:grid-cols-12">
            ...
            <div className="lg:col-span-4 bg-[#0f1f5c] p-10 text-white flex flex-col justify-between relative overflow-hidden">
               ...
               <div className="relative z-10">
                 <h2 className="text-[32px] font-black font-Poppins mb-6 leading-tight">Build Your Future With Us.</h2>
                 <p className="text-blue-100/70 mb-10 leading-relaxed font-medium">
                   Yuva Mitra is a place where passion meets purpose. Join a community dedicated to creating 
                   sustainable impact across rural India.
                 </p>
                 ...
                 <div className="space-y-4">
                   <div className="flex items-center gap-4 bg-white/5 p-5 rounded-xl border border-white/10 hover:bg-white/10 transition-colors cursor-default">
                     ...
                     <div>
                       ...
                       <p className="text-[10px] text-blue-200/50 mt-1">Growth for everyone</p>
                     </div>
                   </div>
                   <div className="flex items-center gap-4 bg-white/5 p-5 rounded-xl border border-white/10 hover:bg-white/10 transition-colors cursor-default">
                     ...
                     <div>
                       ...
                       <p className="text-[10px] text-blue-200/50 mt-1">Direct Social Impact</p>
                     </div>
                   </div>
                   <div className="flex items-center gap-4 bg-white/5 p-5 rounded-xl border border-white/10 hover:bg-white/10 transition-colors cursor-default">
                     ...
                     <div>
                       ...
                       <p className="text-[10px] text-blue-200/50 mt-1">Continuous development</p>
                     </div>
                   </div>
                   {/* <div className="flex items-center gap-4 bg-white/5 p-5 rounded-xl border border-white/10 hover:bg-white/10 transition-colors cursor-default">
            ...
            <div className="lg:col-span-8 p-8 md:p-14 relative overflow-hidden">
              ...
              {submitStatus === 'success' && (
                <div className="mb-8 p-4 bg-green-50 text-green-700 rounded-xl border border-green-100 animate-in fade-in slide-in-from-top-4 duration-700">
                  ...
                  <p className="text-sm">Thank you for applying. Our HR team will review your profile and contact you soon.</p>
                </div>
              )}

              <form onSubmit={handleSubmit} className="space-y-6 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.experience && <p className="text-red-500 text-xs mt-1 ml-1 font-medium">{errors.experience}</p>}
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.institute && <p className="text-red-500 text-xs mt-1 ml-1 font-medium">{errors.institute}</p>}
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-500 block mb-1">
                    ...
                    />
                    {errors.qualification && <p className="text-red-500 text-xs mt-1 ml-1 font-medium">{errors.qualification}</p>}
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    {errors.city && <p className="text-red-500 text-xs mt-1 ml-1 font-medium">{errors.city}</p>}
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group/file overflow-hidden">
                    ...
                    />
                    <div className={`w-full bg-slate-50 border-2 border-dashed rounded-lg px-6 py-5 flex items-center justify-between transition-all duration-300 ${errors.resume ? 'border-red-400 bg-red-50' : 'border-slate-200 group-hover/file:border-secondary group-hover/file:bg-blue-50'}`}>
                       <span className={`text-[16px] font-medium ${errors.resume ? 'text-red-500' : formData.resume ? 'text-secondary' : 'text-slate-400'}`}>
                         {formData.resume ? formData.resume.name : "Choose file or drag & drop"}
                       </span>
                       <div className={`flex items-center gap-3 ${errors.resume ? 'text-red-500' : 'text-slate-500 group-hover/file:text-secondary'}`}>
                          <Upload size={20} className={formData.resume ? "" : "animate-bounce"} />
                          <span className="text-[16px] font-Poppins font-bold">{formData.resume ? "File Added" : "Browse File"}</span>
                       </div>
                    </div>
                  </div>
